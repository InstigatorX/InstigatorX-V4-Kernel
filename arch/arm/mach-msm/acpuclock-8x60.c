...
static struct clkctl_acpu_speed acpu_freq_tbl_slow[] = {
  ...
  { {1, 1}, 1728000,  ACPU_SCPLL, 0, 0, 1, 0x20, L2(19), 1350000, 0x03006000},
  { {1, 1}, 1782000,  ACPU_SCPLL, 0, 0, 1, 0x21, L2(19), 1375000, 0x03006000},
  { {1, 1}, 1836000,  ACPU_SCPLL, 0, 0, 1, 0x22, L2(19), 1400000, 0x03006000},
  { {0, 0}, 0 },
};
